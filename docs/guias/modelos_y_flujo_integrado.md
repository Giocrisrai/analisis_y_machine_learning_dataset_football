...
Documento para **explicar en clase** cómo encajan los algoritmos que usa el repositorio y cómo se integran con **CRISP-DM**, el **notebook** y los **pipelines Kedro**. Convive con [crispdm_y_machine_learning.md](crispdm_y_machine_learning.md) y la visión panorámica del ciclo de datos en **[ciclo_ciencia_datos_artefactos.md](ciclo_ciencia_datos_artefactos.md)**.
